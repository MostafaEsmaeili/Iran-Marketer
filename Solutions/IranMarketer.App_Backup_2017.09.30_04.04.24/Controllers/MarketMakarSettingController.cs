...
{
    public class MarketMakarSettingController : BaseController
    {
        [HttpPost]

        public ActionResult SaveSetting(MarketMakarSetting setting)

        {
            try
            {
                var req = ApiHelper.Request(ApiAddressProvider.SettingApi + "SaveMarketMakarSetting", Method.POST);
                req.AddJsonBody(new BaseReportFilter<AddMarketMakarSettingFilter>
                {
                    ReportFilter = new AddMarketMakarSettingFilter
                    {
                        Setting = setting
                    }
                });
        ...
        public JsonResult GetHistoricalMarketMakarSettings([DataSourceRequest] DataSourceRequest request)
        {
            try
            {
                var req = ApiHelper.Request(ApiAddressProvider.SettingApi + "GetAllMarketMakarSettings", Method.POST);
                ...
                var res = req.Exec<ApiPagedCollectionResponse<MarketMakarSetting>>(this);
        ...
        public ActionResult MarketMakarSettingsByGuid(string id)
        {

            try
            {
                var req = ApiHelper.Request(ApiAddressProvider.SettingApi + "GetMarketMakarSettingByGuid", Method.POST);
                ...
                var res = req.Exec<ApiResponse<MarketMakarSetting>>(this);
