...
namespace IranMarketer.App.Controllers
{
    ...
    public class UserManagementController : BaseController
    {
        ...
        public JsonResult AddUser(UserManagementAddFilter model)
        {
            try
            {
                var req = ApiHelper.Request(ApiAddressProvider.AccountApi + "AddUser", Method.POST);
                req.AddJsonBody(new BaseReportFilter<UserManagementAddFilter>
                {
                    ReportFilter = model
                });
                var res = req.Exec<ApiResponse<object>>(this);
        ...
        public ActionResult GetUsersByFilter([DataSourceRequest] DataSourceRequest request)
        {
            ...
            try
            {
                ...
                var res = req.Exec<ApiPagedCollectionResponse<UserManagement>>(this);
