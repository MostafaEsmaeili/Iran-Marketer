...
{
    public class TseBondFeeSettingController : BaseController
    {

        [HttpPost]
        public ActionResult SaveSetting(TseBondFeeSetting setting)

        {
            try
            {
                setting.ValidFrom = DateTime.Now;
                var req = ApiHelper.Request(ApiAddressProvider.TradeFeeSettingApi + "SaveTseBondFeeSetting", Method.POST);
                req.AddJsonBody(new ApiRequest<TseBondFeeSetting>
                {
                    Entity = setting
                });
        ...
        public JsonResult GetLastSetting()
        {
            ...
            try
            {
                ...
                var req = ApiHelper.Request(ApiAddressProvider.TradeFeeSettingApi + "GetCurrentTseBondFeeSetting", Method.POST);
                ...
                var res = req.Exec<ApiResponse<TseBondFeeSetting>>(this);
