...
{
    public class BranchManagerSettingController : BaseController
    {
        [HttpPost]

        public ActionResult SaveSetting(BranchManagerSetting setting)

        {
            try
            {
                var req = ApiHelper.Request(ApiAddressProvider.SettingApi + "SaveBranchManagerSetting", Method.POST);
                req.AddJsonBody(new BaseReportFilter<AddBranchManagerSettingFilter>
                {
                    ReportFilter = new AddBranchManagerSettingFilter
                    {
                        Setting = setting
                    }
                });
        ...
        public JsonResult GetHistoricalBranchManagerSettings([DataSourceRequest] DataSourceRequest request)
        {
            try
            {
                var req = ApiHelper.Request(ApiAddressProvider.SettingApi + "GetAllBranchManagerSettings", Method.POST);
                ...
                var res = req.Exec<ApiPagedCollectionResponse<BranchManagerSetting>>(this);
        ...
        public ActionResult BranchManagerSettingsByGuid(string id)
        {

            try
            {
                var req = ApiHelper.Request(ApiAddressProvider.SettingApi + "GetBranchManagerSettingByGuid", Method.POST);
                ...
                var res = req.Exec<ApiResponse<BranchManagerSetting>>(this);
