...
{
    public class SubscriptionStatementPdfProvider : BasePdfProvider
    {
        public SubscriptionStatementPdfProvider()
        {
            Category=ReportCategory.SubscriptionStatement;
        }
   
        public override void SetVariables<T>(T data)
        {
            ReportFile.Load(GetReportMrtPath());
            var formattedData = data as SubscriptionStatement;
            if (formattedData != null)
            {
                ...
                ReportFile.Dictionary.Variables.Add("RemainAmount", formattedData.RemainAmount);
                ...
                ReportFile.Dictionary.Variables.Add("BeforeVolume", formattedData.RemainVolume-formattedData.EvidenceVolume);
