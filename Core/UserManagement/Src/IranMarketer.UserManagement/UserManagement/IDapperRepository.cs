...
{
    public interface IDapperRepository<T> : IDapperRepository<T, object> where T : class
    {

    }
    public interface IDapperRepository<T, TKey> where T : class
    {
        long Insert(T item);
    ...
    public class DapperDapperRepository<T> : DapperRepository<T, object>, IDapperRepository<T> where T : class
    {
        public DapperDapperRepository(IDbConnection connection)
            : this(connection, null)
        {
        }
        public DapperDapperRepository(IDbConnection connection, IDbTransaction transaction = null)
    ...
    public class DapperRepository<T, TKey> : IDapperRepository<T, TKey>, IDisposable where T : class
    {
