...
namespace IranMarketer.UserManagement
{
    ...
    {private CustomLogger  Logger=>new CustomLogger(GetType().FullName);
        ...
        {
            //if (DbContent.RoleRepository != null && DbContent.RoleRepository is DapperDapperRepository<TRole>)
            //{
            //    var rr = DbContent.RoleRepository as DapperDapperRepository<TRole>;
            //    rr.Dispose();
            //}
        }
    }
