    ...
    public static partial class SqlMapperExtensions
    {
        ...
        private static string GetTableName(Type type)
        {
            ...
            if (!TypeTableName.TryGetValue(type.TypeHandle, out name))
            {
                ...
                TypeTableName[type.TypeHandle] = schema + "." + name;
            }
            return schema+"."+name;
        }
        ...
        class ProxyGenerator
        {
            ...
            public static T GetInterfaceProxy<T>()
            {
                ...
                var interfaceType = typeof(IranMarketer.UserManagement.SqlMapperExtensions.IProxy);
            ...
            private static MethodInfo CreateIsDirtyProperty(TypeBuilder typeBuilder)
            {
                ...
                var getMethod = typeof(IranMarketer.UserManagement.SqlMapperExtensions.IProxy).GetMethod("get_" + "IsDirty");
                var setMethod = typeof(IranMarketer.UserManagement.SqlMapperExtensions.IProxy).GetMethod("set_" + "IsDirty");
