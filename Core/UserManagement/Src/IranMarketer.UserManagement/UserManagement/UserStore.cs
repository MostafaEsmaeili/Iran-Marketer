...
namespace IranMarketer.UserManagement
{
        ...
        where TUser : IdentityUser where TRole:IdentityRole
    {
        ...
        public override async Task<IList<UserLoginInfo>> GetLoginsAsync(TUser user)
        {
            ...
            var result = await DbContent.UserLoginDapperRepository.FindAsync(c => c.UserId == user.Id);
        ...
        public override async Task<IList<System.Security.Claims.Claim>> GetClaimsAsync(TUser user)
        {
            ...
            var result = await DbContent.UserClaimDapperRepository.FindAsync(c => c.UserId == user.Id);
        ...
        public override async Task RemoveClaimAsync(TUser user, System.Security.Claims.Claim claim)
        {
            ...
            await DbContent.UserClaimDapperRepository.RemoveAsync(c =>c.UserId == user.Id 
        ...
        public override async Task RemoveFromRoleAsync(TUser user, string roleName)
        {
            ...
            if (roles != null && roles.Any())
            {
                ...
                await DbContent.UserRoleDapperRepository.RemoveAsync(c => c.RoleId == role.Id && c.UserId == user.Id);
            }
        }
        public override async Task RemoveLoginAsync(TUser user, UserLoginInfo login)
        {
            ...
            await DbContent.UserLoginDapperRepository.RemoveAsync(c => c.UserId == user.Id 
        ...
        where TUser : IdentityUser<TKey> where TRole:IdentityRole<TRoleKey>
    {
        ...
        public virtual async Task AddLoginAsync(TUser user, UserLoginInfo login)
        {
            ...
            await DbContent.UserLoginDapperRepository.InsertAsync(userLogin);

        }

        public virtual async Task<TUser> FindAsync(UserLoginInfo login)
        {
            var task = DbContent.UserLoginDapperRepository.FindAsync(c => c.LoginProvider == login.LoginProvider && c.ProviderKey == login.ProviderKey);
            task.Wait();
        ...
        public virtual async Task<IList<UserLoginInfo>> GetLoginsAsync(TUser user)
        {
            ...
            var result= await DbContent.UserLoginDapperRepository.FindAsync(c => (object)c.UserId == (object)user.Id);
            IList<UserLoginInfo> rs = new List<UserLoginInfo>();
            if (result != null && result.Any())
            {
                foreach (var login in result)
        ...
        public virtual async Task RemoveLoginAsync(TUser user, UserLoginInfo login)
        {
            ...
            await DbContent.UserLoginDapperRepository.RemoveAsync(c=>(object)c.UserId==(object)user.Id && c.ProviderKey==login.ProviderKey && c.LoginProvider==login.LoginProvider);
        }
        ...
        {
            //if (DbContent.UserRepository != null && DbContent.UserRepository is DapperDapperRepository<TUser>)
            //{
            //    var rr = DbContent.UserRepository as DapperDapperRepository<TUser>;
            //    rr.Dispose();
            //}
        }
        ...
        public virtual async Task AddClaimAsync(TUser user, System.Security.Claims.Claim claim)
        {
            ...
            await DbContent.UserClaimDapperRepository.InsertAsync(userClaim);
        }
        ...
        public virtual async Task<IList<System.Security.Claims.Claim>> GetClaimsAsync(TUser user)
        {
            ...
            var result = await DbContent.UserClaimDapperRepository.FindAsync(c => (object)c.UserId == (object)user.Id);
            IList<System.Security.Claims.Claim> rs = new List<System.Security.Claims.Claim>();
            if (result != null && result.Any())
            {
                foreach (var login in result)
        ...
        public virtual async Task RemoveClaimAsync(TUser user, System.Security.Claims.Claim claim)
        {
            ...
            await DbContent.UserClaimDapperRepository.RemoveAsync(c=>(object)c.UserId==(object)user.Id && c.ClaimValue==claim.Value && c.ClaimType==claim.ValueType);
        }
        ...
        public virtual async Task AddToRoleAsync(TUser user, string roleName)
        {
            ...
            if(roles!=null && roles.Any())
            {
                ...
                await DbContent.UserRoleDapperRepository.InsertAsync(userRole);
            }
        }
        ...
        private string GetRoleNamesSqlString()
        {
            ...
            var userRoleTableName=DbContent.UserRoleDapperRepository.GetTableName<IdentityUserRole<TKey,TRoleKey>>();
        ...
        public virtual async Task RemoveFromRoleAsync(TUser user, string roleName)
        {
            ...
            if (roles != null && roles.Any())
            {
                ...
                await DbContent.UserRoleDapperRepository.RemoveAsync(c => (object)c.RoleId == (object)role.Id && (object)c.UserId == (object)user.Id);
            }
        }
