...
namespace IranMarketer.Domain.Entity
{
    ...
    public class WorkExperience
    {
        ...
        [Column(@"Created", Order = 13, TypeName = "datetime")]
        [Display(Name = "Created")]
        public System.DateTime? Created { get; set; }

        [Column(@"Modified", Order = 14, TypeName = "datetime")]
        ...
        [Column(@"ModifiedBy", Order = 16, TypeName = "nvarchar")]
        [MaxLength(50)]
        [StringLength(50)]
        ...
        [ForeignKey("IndustryId")] public Industry Industry { get; set; }

        [ForeignKey("JobCategoryId")] public JobCategory JobCategory { get; set; }

        [ForeignKey("JobCityId")] public Region Region { get; set; }
